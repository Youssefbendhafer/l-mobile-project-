...
const Tablep = () => {
  const [items, setItems] = useState([
    { id: 1, name: 'Item 1', price: 45, email: 'item1@example.com', totalAchat: 100 },
    { id: 2, name: 'Item 2', price: 25, email: 'item2@example.com', totalAchat: 200 },
    { id: 3, name: 'Item 3', price: 15, email: 'item3@example.com', totalAchat: 300 },
    { id: 4, name: 'Item 4', price: 35, email: 'item4@example.com', totalAchat: 400 },
  ]);
  ...
  const handleSave = () => {
    const updatedItems = items.map(item =>
      item.id === editingItem.id
        ? { ...item, id: newId, name: newName, price: newPrice, email: newEmail, totalAchat: newTotalAchat }
        : item
    );
